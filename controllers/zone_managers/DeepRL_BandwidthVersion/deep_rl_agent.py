...
class DQN(nn.Module):
    ...
    def __init__(self, input_dim, output_dim):
        ...
        self.fc1 = nn.Linear(input_dim, Config.STGTConfig.HIDDEN_DIM)
        self.fc2 = nn.Linear(Config.STGTConfig.HIDDEN_DIM, Config.STGTConfig.HIDDEN_DIM)
        self.fc3 = nn.Linear(Config.STGTConfig.HIDDEN_DIM, output_dim)
...
class DeepRLAgent:
    ...
    def train(self, batch_size=Config.STGTConfig.BATCH_SIZE):
        """
